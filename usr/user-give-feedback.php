  ...
  if(isset($_POST['give_feedback']))
    {
            ...
            $query="insert into tms_feedback (f_uname, f_content, lessor_name, car_name) values(?,?,?,?)";
            $stmt = $mysqli->prepare($query);
            $rc=$stmt->bind_param('ssss', $f_uname, $f_content, $lessor_name, $car_name);
            $stmt->execute();
                if($stmt)
                {
      ...
      <?php if(isset($succ)) {?>
        ...
        <div class="card-body">
          ...
          <form method ="POST"> 
            ...
            <div class="form-group">
                <label for="exampleInputEmail1">Lessor Name</label>
                <input type="text" required class="form-control" id="exampleInputEmail1" name="lessor_name">
            </div>
            
            <div class="form-group">
                <label for="exampleInputEmail1">Car Name &amp; Registration Number</label>
                <input type="text" required class="form-control" id="exampleInputEmail1" name="car_name">
            </div>
            <div class="form-group">
